    ...
    <div id="slides" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <img src="img/mostra.jpg" alt="Mostra">
            </div>
            <div class="carousel-item">
            ...
            <div class="carousel-item">
                <img src="img/museo.jpg" alt="Museo">
            </div>
            <div class="carousel-item">
                <img src="img/concerto.jpg" alt="Concerto">
            </div>
        </div>
...
<div class="row padding">
    <div class="col-md-4">
        <div class="card">
            <img src="img/cinema.jpg" alt="Categoria Cinema" class="card-imd-top">
            <div class="card-body">
                <a href="#" class="card-category">Cinema</a>
            </div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="card">
            <img src="img/concerto.jpg" alt="Categoria Concerto" class="card-imd-top">
            <div class="card-body">
                <a href="#" class="card-category">Concerto</a>
            </div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="card">
            <img src="img/party.jpg" alt="Categoria Party" class="card-imd-top">
            <div class="card-body">
                <a href="#" class="card-category">Party</a>
            </div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="card">
            <img src="img/teatro.jpg" alt="Categoria Teatro" class="card-imd-top">
            <div class="card-body">
                <a href="#" class="card-category">Teatro</a>
            </div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="card">
            <img src="img/museo.jpg" alt="Categoria Museo" class="card-imd-top">
            <div class="card-body">
                <a href="#" class="card-category">Museo</a>
            </div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="card">
            <img src="img/mostra.jpg" alt="Categoria Mostra" class="card-imd-top">
            <div class="card-body">
                <a href="#" class="card-category">Mostra</a>
            </div>
        </div>
    </div>
</div>    
